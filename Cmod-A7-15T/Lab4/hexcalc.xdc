...
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { bt_plus }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { bt_eq }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
