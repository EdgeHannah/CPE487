...
HD_PWD='C:/Users/eastc/Desktop/CPE487/Cmod-A7-15T/Lab1/ledBtnCtrl/ledBtnCtrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ledBtnCtrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ledBtnCtrl.tcl -notrace
