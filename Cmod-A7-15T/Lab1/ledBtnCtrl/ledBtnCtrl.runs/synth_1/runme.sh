...
HD_PWD='C:/Users/eastc/Desktop/CPE487/Cmod-A7-15T/Lab1/ledBtnCtrl/ledBtnCtrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledBtnCtrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ledBtnCtrl.tcl
