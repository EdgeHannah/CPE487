...
#
# Generated by Vivado on Thu Nov 19 13:34:04 -0500 2020
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../vga_ball.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../vga_ball.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
